package com.jvjp.instragamwithjetpackcompose
...
fun Body(modifier: Modifier) {
    ...
    var isLogibEnable by rememberSaveable { mutableStateOf(false) }
    ...
    Column(modifier = modifier) {
        ...
        Email(email, { email = it
            isLogibEnable = enableLogin(email, password)
        })
...
fun Password(password: String, onTextChanged: (String) -> Unit) {
    ...
    TextField(
        ...
        trailingIcon = {
            val imagem = if (passwordVisibility) {
